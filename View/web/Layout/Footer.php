...
<footer>
	...
	<div class="copy-right py-3">
		<div class="container">
			<p class="text-center text-white">© <?php echo date("Y");?> Shopland. Todos Los Derechos Reservados | Diseñado Por
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="/../../../proyecto/View/web/js/jquery-2.2.3.min.js"></script>
	<!-- //jquery -->
	...
	<script src="/../../../proyecto/View/web/js/jquery.magnific-popup.js"></script>
	<script>
		$(document).ready(function () {
	...
	<!-- cart-js -->
	<script src="/../../../proyecto/View/web/js/minicart.js"></script>
	<script>
	...
	<!-- scroll seller -->
	<script src="/../../../proyecto/View/web/js/scroll.js"></script>
	<!-- //scroll seller -->

	<!-- smoothscroll -->
	<script src="/../../../proyecto/View/web/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="/../../../proyecto/View/web/js/move-top.js"></script>
	<script src="/../../../proyecto/View/web/js/easing.js"></script>
	<script>
	...
	<script src="/../../../proyecto/View/web/js/bootstrap.js"></script>
	<!-- //for bootstrap working -->
	<!-- //js-files -->
</body>
