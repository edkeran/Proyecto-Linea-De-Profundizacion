...
<head>
    ...
    <title>Formulario Para El Registro De Un Vendedor</title>
    <!-- Favicon-->
...
<body class="signup-page">
    <div class="signup-box">
        <div class="logo">
            <a href="javascript:void(0);">Shop<b>land</b></a>
            <small>La Mejor Tienda Virtual De La Region</small>
        </div>
        <div class="card">
            <div class="body">
                <form id="sign_up" action="../../../../../HandleRequest/routes?ruta=registrar.register" method="POST">
                    <div class="msg">Registra A Un Nuevo Vendedor</div>
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="text" class="form-control" name="nmUsr" placeholder="Nombre Usuario" required autofocus>
                        </div>
                    </div>
                    <div class="input-group">
                        <span class="input-group-addon">
                    ...
                    <div class="input-group">
                        ...
                        <div class="form-line">
                            <input type="password" class="form-control" name="confirmPass" minlength="4" placeholder="Confirmar Contraseña" required>
                        </div>
                    </div>
